...
const imports = [
  ...
  { specifier: 'nexus-ai-pro/graph/visualize', exports: ['toMermaid', 'toGraphJSON'] },
  ...
  { specifier: 'nexus-ai-pro/prompts/client', exports: ['PromptClient'] },
  {
    specifier: 'nexus-ai-pro/prompts/registry',
    exports: [
      'PromptRegistry',
      'MemoryPromptStore',
      'experimentGate',
  ...
  { specifier: 'nexus-ai-pro/prompts/file', exports: ['FilePromptStore'] },
  { specifier: 'nexus-ai-pro/prompts/redis', exports: ['RedisPromptStore'] },
